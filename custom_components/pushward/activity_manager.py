...
# call sites below read better without the module prefix.
_downsample_evenly = downsample_evenly
...
class ActivityManager:
    ...
    async def _recorder_states(self, entity_ids: list[str], period_minutes: int) -> dict[str, list[dict]]:
        ...
        Thin delegate to recorder_history so tests keep a single seam to patch.
        """
        return await async_recorder_states(self._hass, entity_ids, period_minutes)
