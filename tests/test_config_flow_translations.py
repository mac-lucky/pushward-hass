...
# The image trio rides on the templates the server gives an image slot to
# (IMAGE_TEMPLATES): generic, steps and media.
...
ENTITY_FROZEN_FIELDS: dict[str, set[str]] = {
    ...
    "media": _ENTITY_COMMON
    | _ENTITY_IMAGE
    | {
        "media_controls",
        "media_favorite_script",
    },
}
